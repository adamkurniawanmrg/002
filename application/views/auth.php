...
<head>
    ...
    <title>Layanan E-Gov Labura</title>
                    ...
                    <div class="login-inner-form">
                        <div class="details">
                            <div class="logo-mini">
                                ...
                                <h3 class="mb-2">LAYANAN E-GOV LABURA</h3><br/>
                                <!--<h3 class="text-white">Kabupaten Labuhanbatu Utara</h3>-->
                            </div>
                            <div class="none-992">
                                 <h3>LAYANAN E-GOV LABURA</h3>
                            </div>
                            ...
                            <form action="" method="POST">
                                ...
                                <div class="mb-2" style="color: #fefefe">
                                    Jika ada pertanyaan kirim<br/>Telegram <a href="https://t.me/egovlabura">@egovlabura</a></b>
                                    <!--Jika ada pertanyaan kirim<br/>Telegram: <b>@egovlabura</b>-->
                                </div>
